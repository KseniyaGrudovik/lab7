package bsu.rfe.java.group7.lab7.Grudoik.varA3;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try{
                    ...
                    while(not_pressed) {
                        System.out.println("Ждём пока считает адрес....");
                    };
...
// Выводим сообщение в текстовую область
    ...
    private void sendMessage() {
        try {
            final String Adi = textFieldTo.getText();
            String[] parts = Adi.split(":");
            System.out.println(Adi);
            final String destinationAddress = parts[0];
...
// Помещаем сообщения в текстовую область вывода
            textAreaIncoming.append("Я -> " + IP + ":" +SERVER_PORT + ": "
                    + message + "\n");
